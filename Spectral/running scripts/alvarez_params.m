...
SpectralParams.InterpolationRes = 200;
...
ChosenMaterials = { 'C5HO2H8','Al', 'C31H64','I'}; %choose the materials you wish for the basis
iodine_frac = 0.2;
ReconstructionParams.base = [20 1.5 0.125]./512*(512/ReconstructionParams.PhantomRes);%Weightening for the material densities
calibration_region = 0.1*[20 1.5 0.125];
...
ReconstructionParams.La_coeffs = [20 1.5 0.125]; %a metric coefficients, used for scaling
ReconstructionParams.iters = 2000; %Maximal number of iterations of the minimization algorithm
