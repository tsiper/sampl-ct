...
ReconstructionParams.fileRecordName = 'run_8_switching';
save_name = 'run_8_switching';
...
ChosenMaterials = { 'I','Ca'}; %choose the materials you wish for the basis
ReconstructionParams.base = [0.125 1 ]./255;%Weightening for the material densities
...
ReconstructionParams.lambda = 1e-10; %lambda for TV step
ReconstructionParams.L =1000*SpectralParams.K; %Lipschitz coeeficient. optimal 90 with calibration region , 800 for distinct materials,0.5adipose&water
