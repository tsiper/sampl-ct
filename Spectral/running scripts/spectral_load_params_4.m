...
ReconstructionParams.fileRecordName = 'adipose_water_RLcirc';
save_name = 'adipose_water_RLcirc';
...
I = 2; %Number of materials
ChosenMaterials = { 'adipose','water'}; %choose the materials you wish for the basis
ReconstructionParams.base = [1 1];%Weightening for the material densities


%% Loading phantom
% chosen phantom can be either: 'circles', 'more_circles', 'paint',
% 'spectral_shepp', 'spectral_zubal', 'RLcirc'.
chosen_phantom = 'RLcirc';
...
ReconstructionParams.noiseLevel = 0.01;
ReconstructionParams.lambda = 0.00005; %lambda for TV step
ReconstructionParams.L =0.5*SpectralParams.K; %Lipschitz coeeficient. optimal 90 with calibration region , 800 for distinct materials,0.5adipose&water
ReconstructionParams.La_coeffs = [1 1]; %a metric coefficients, used for scaling
ReconstructionParams.iters = 10000; %Maximal number of iterations of the minimization algorithm
