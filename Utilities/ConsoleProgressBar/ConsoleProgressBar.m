classdef ConsoleProgressBar < handle
    ...
    properties (GetAccess = public, SetAccess = private)
        ...
        maximum = 1                     % Maximum progress value
        ...
        percentPosition = 'right'        % Percent text position 'left' or 'right'
        
%         isElapsedTimeVisible = false    % Elapsed time text visible flag
        isElapsedTimeVisible = true    % Elapsed time text visible flag
        elapsedTimePosition = 'left'   % Elapsed time text position
        
%         isRemainedTimeVisible = false   % Remained time text visible flag
        isRemainedTimeVisible = true    % Remained time text visible flag
