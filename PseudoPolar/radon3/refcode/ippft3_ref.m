% function [Y,flag,residual,iter] = ippft3_ref(pp,ErrTol,MaxIts,verbose);
%
...
temp = precondadjppft3_ref(pp);
[Y,flag,residual,iter] = CG('PtP3_ref',temp,{},ErrTol,MaxIts,zeros(size(temp)),verbose);
if flag
