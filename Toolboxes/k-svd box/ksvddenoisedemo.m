...
im2 = imread(imgname);
im_notbarbara = imread('images/lena.png');
im_notbarbara=im_notbarbara(:,:,1);
im_notbarbara=double(im_notbarbara);
im = im2(:,:,1);
im = double(im);
...
imnoise1= im +0.5*n;
imnoise2= im +2*n;
im_final = [im_notbarbara,imnoise,im_notbarbara,im_notbarbara,im_notbarbara];
...
figure; imshow(imout(:,1:512)/params.maxval);
