...
%                 each step.
%       box       Double; upper bound L in box constraint [0,L] on pixel values.
...
% Jacob Frøsig, Nicolai Riis, Per Chr. Hansen, July 5, 2015, DTU Compute.
% Based on kaczmarc from AIR Tools.
